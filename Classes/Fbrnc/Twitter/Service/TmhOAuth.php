...
namespace Fbrnc\Twitter\Service;
...
class TmhOAuth {
	 ...
	 *
	 * @param int $length how many characters the nonce should be before MD5 hashing. default 12
	 * @param bool $include_time whether to include time at the beginning of the nonce. default true
	 * @return void
	 */
